import 'package:ace/otp.dart';
import 'package:ace/register.dart';
        ...
        child: Container(
          child: Column(
            children: [
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIconColor: MaterialStateColor.resolveWith(
                          (states) => states.contains(MaterialState.focused) ? (_numberError != null ? Colors.red : Colors.black) : Colors.black,
                    ),
                  ),
                  onChanged: (value) {
                    setState(() {
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(50, 10, 40, 0),
                child: Row(
                  children: [
                    Switch(
                      value: _isSwitched,
