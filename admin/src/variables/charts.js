...
export const barChartDataDailyTraffic = [
  {
    name: "recycling rates over past year",
    data: [20, 30, 40, 20, 45, 50, 30, 22, 15, 12, 30, 36 ],
  },
];
...
export const barChartOptionsDailyTraffic = {
  ...
  xaxis: {
    categories: ["00", "04", "08", "12", "14", "16", "18","20","22","24"],
    show: false,
    labels: {
      show: true,
      style: {
...
export const pieChartOptions = {
  labels: ["Recyclable", "Non-Recyclable", "Biodegradable", "Hazardous", "Other"],
  colors: ["#4318FF", "#6AD2FF", "#2965CC", "#0077CC", "#CBD5E0"],
  chart: {
...
export const pieChartData = [30, 20, 25, 10, 15];
...
export const resourcespieChartOptions = {
  labels: ["Running", "Idle", "Stopped", "Ready"],
  colors: ["#4318FF", "#6AD2FF", "#EFF4FB","#6AD"],
  chart: {
    width: "50px",
  },
  states: {
...
export const resourcespieChartData = [30, 20, 25, 10];